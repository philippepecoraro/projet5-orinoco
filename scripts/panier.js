...
const reduced = contenuPanier.reduce((accumulateur, values) => accumulateur + (values.prix)*(values.quantite), 0);
console.log(reduced);
      ...
      <h3>Formulaire de contact</h3>
                <form id="formulaire-form">
                    <div class="prenom">
                        ...
                        <input name="prenom" id="prenom" type="text" pattern="[A-Za-z-éè ]{1,25}" title="Veuillez entrez des lettres et pas des nombres" required>
                    </div>
                    <div class="nom">
                        <label for="nom">Nom: </label>
                        <input name="nom" id="nom" type="text" pattern="[A-Za-z-éè ]{1,25}" title="Veuillez entrez des lettres et pas des nombres" required>
                    </div>
                    <div class="adresse">
                    ...
                    <div class="ville">
                        ...
                        <input name="ville" id="ville" type="text" pattern="[A-Za-z-éè ]{1,25}" title="Veuillez entrez des lettres et pas des nombres" required>
                    </div>
                    <div class="email">
...
ajouterContact.addEventListener('submit', function(event) {
 ...
 //On ajoute dans le tableau
  ...
  let form = document.getElementById('formulaire-form');
  postContactProduct()
    .then(responseData => {
      ...
      if (!form.checkValidity()) {
        winndow.alert("Erreur de saisie");
          ...
          let productOrderTotalCoast = reduced;        
          console.log(reduced);
          console.log(responseData.orderId);
          console.log(responseData);
          //vidage du panier
          localStorage.clear();            
          let productOrderTotal = { productOrderId, productOrderTotalCoast};
